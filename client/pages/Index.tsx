...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
            ...
            <div style={{ padding: '32px', backgroundImage: 'linear-gradient(to right bottom, rgb(44, 49, 58), rgb(70, 74, 83))', borderRadius: '16px', border: '0.8px solid rgb(107, 114, 128)' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <span style={{ color: '#00B2FF', fontFamily: 'Inter, sans-serif' }}>
                    {deploymentProgress}%
                  </span>
                </div>
                <div style={{ backgroundColor: 'rgb(31, 34, 41)', borderRadius: '50px', height: '8px', marginTop: '24px', position: 'relative', overflow: 'hidden' }}>
                  <div
                    style={{
                      ...
                      position: 'relative',
                      boxShadow: deploymentProgress === 100 ? '0 0 12px rgba(0, 178, 255, 0.6)' : 'none',
                ...
                <div style={{ marginTop: '24px' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      color: activeStep >= 4 ? '#00B2FF' : '#9096a2',
                      fontSize: '14px',
                      marginLeft: '12px',
                      fontFamily: 'Inter, sans-serif',
                      fontWeight: activeStep >= 4 ? '600' : '400',
      ...
      <section
        id="final-cta"
        style={{ padding: '64px 0', background: 'linear-gradient(90deg, #24005A 0%, #3B00C8 50%, #00C2FF 100%)' }}
      >
        <div className="container mx-auto px-6">
